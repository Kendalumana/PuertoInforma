...
                        <div className="rango-nombre">{rango.urlIcono && <img src={rango.urlIcono} alt="icono" style={{ width: '30px', height: '30px', marginRight: '0.4rem', verticalAlign: 'middle', objectFit: 'contain' }} />}{rango.nombre}</div>
